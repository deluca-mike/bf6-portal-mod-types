...
The official BF6 Portal SDK uses a **four-part** version (e.g. `1.4.2.0`) for the `mod` namespace and does not follow
...
| `1.4.1.0` (past)             | `4.1.x`      |
| `1.4.2.0` (current)          | `4.2.x`      |
| `1.4.3.0` (future example)   | `4.3.x`      |

- **Minor** version changes (e.g. `4.2.0` → `4.3.0`) align with a new official SDK release and may add or change APIs.
- **Patch** versions (e.g. `4.2.0` → `4.2.1`) keep the same underlying SDK version and only add or improve documentation
...
The full API reference (generated from these type definitions and their JSDoc) is published as GitHub Pages for this
repo:
...
For contribution, build, and verification details, see [CONTRIBUTING.md](CONTRIBUTING.md) in the repository.
