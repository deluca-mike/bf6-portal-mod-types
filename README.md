...
The official BF6 Portal SDK uses a **four-part** version (e.g. `1.3.2.0`) for the `mod` namespace and does not follow
...
| `1.2.3.0` (past)             | `2.3.x`      |
| `1.3.2.0` (current)          | `3.2.x`      |
| `1.3.3.0` (future example)   | `3.3.x`      |

- **Minor** version changes (e.g. `3.2.0` → `3.3.0`) align with a new official SDK release and may add or change APIs.
- **Patch** versions (e.g. `3.2.0` → `3.2.1`) keep the same underlying SDK version and only add or improve documentation
